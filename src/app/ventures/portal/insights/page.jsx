        ...
        {showFeatured && featuredInsight && (
          <Reveal>
            <button
              ...
              className="w-full text-left mb-6 bg-gradient-to-br from-[#13131F] to-[#1A1A2E] border border-[#6D4A9E]/30 rounded-xl p-6 md:p-8 transition-all duration-200 hover:border-[#6D4A9E]/60 hover:shadow-xl hover:shadow-[#6D4A9E]/5 group"
            >
              <div className="flex items-center gap-2 mb-3">
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-mono font-medium bg-[#6D4A9E]/15 text-[#9B72CF] border border-[#6D4A9E]/30">
                  Macro Overview
                </span>
                <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-mono text-[#C9A84C] bg-[#C9A84C]/10 border border-[#C9A84C]/20">
                  Start Here
                </span>
              </div>
              ...
              <p className="text-sm text-[#7A7A9A] leading-relaxed mb-4 max-w-3xl">
