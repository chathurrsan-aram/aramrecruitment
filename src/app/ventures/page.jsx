      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 top-[6%] md:inset-x-auto md:left-1/2 md:-translate-x-1/2 md:w-[640px] max-h-[88vh] overflow-y-auto z-[60] rounded-2xl bg-white border border-gray-200 shadow-2xl"
          >
            <button
              onClick={onClose}
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  ...
                  <div key={stat.label} className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center">
                    <p className="font-display text-2xl font-bold text-[#6D4A9E] mb-1">{stat.value}</p>
              ...
              {/* Why now */}
              <h3 className="font-display text-lg font-semibold text-gray-900 mb-4">Why now?</h3>
              ...
              {/* What's Inside */}
              <h3 className="font-display text-lg font-semibold text-gray-900 mb-4">What&apos;s inside the platform</h3>
              <div className="space-y-3 mb-6">
                {[
                  ...
                  <div key={item.title} className="flex items-start gap-3 p-4 rounded-xl bg-gray-50 border border-gray-200">
                    <div className="w-10 h-10 rounded-lg bg-[#6D4A9E]/10 flex items-center justify-center flex-shrink-0">
                      <item.icon className="w-5 h-5 text-[#6D4A9E]" />
                    </div>
                    <div>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-8 py-6 md:py-10">
      <Reveal>
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-sm font-medium text-[#6D4A9E] hover:text-gray-900 transition-colors mb-6 bg-[#6D4A9E]/10 px-4 py-2 rounded-lg group"
        >
      ...
      <Reveal delay={0.15}>
        <section className="mb-8">
          ...
          <p className="text-[15px] leading-relaxed text-gray-500">{page.observation}</p>
        </section>
      </Reveal>
        ...
        <section className="mb-8">
          ...
          <StaggerContainer staggerDelay={0.07} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {page.keyMetrics.map((metric, i) => (
              <StaggerItem key={i}>
                <div className="bg-white border border-gray-200 rounded-lg p-4 hover:border-[#6D4A9E]/30 transition-colors">
        ...
        <section className="mb-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-5 space-y-3">
            ...
            <div className="pt-3 border-t border-gray-200">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">{page.investmentParameters.keyRisk}</p>
            </div>
          </div>
        </section>
      </Reveal>
        ...
        <section className="mb-8">
          ...
          <StaggerContainer staggerDelay={0.06} className="space-y-2">
            {page.namedPlayers.map((player, i) => (
              <StaggerItem key={i}>
                <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-3 bg-white border border-gray-200 rounded-lg p-4 hover:border-[#6D4A9E]/20 transition-colors">
              ...
              <AnimatePresence>
                {selectedInsight && (
                  <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    transition={{ duration: 0.2 }}
                    className="fixed inset-0 z-[9999] bg-[#FAFAFA] overflow-y-auto"
                  >
                    <InlineInsightDetail
