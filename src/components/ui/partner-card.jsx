...
export default function PartnerCard({ partner }) {
  return (
    <div className="rounded-xl border border-aram-warm-200 bg-white p-5 transition-all hover:border-aram-purple hover:-translate-y-0.5 hover:shadow-lg min-w-[260px]">
